...
class UI_Manager(State_Machine):
    ...
    def update_lstbox_widgets(self, window, frame_up, frame_bot):
        ...
        btn_add_cats = self.create_button(frame_up, 'Add 5 Cat', lambda:self.add_5_items())
        btn_add_prods = self.create_button(frame_up, 'Add 5 Prod.', lambda:self.add_5_items())
