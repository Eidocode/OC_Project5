...
class DatabaseManager:
    ...
    ----------
    sql_connx : tuple
        Contains SQL server informations like credentials, @IP,
        database name...
    ...
    set_query(query, datas)
        ...
        ex : 'INSERT INTO Categories (name, json_id, url) VALUES (%s, %s, %s)'
    """
    ...
    def get_query(self, query):
        ...
        try:
            ...
            str1 = "Failed to get record from table {}".format(error)
            print(Fore.RED + str1)
    ...
    def set_query(self, query, datas, many=True):
        ...
        try:
            ...
            str1 = "Failed to insert record into table {}".format(error)
            print(Fore.RED + str1)
